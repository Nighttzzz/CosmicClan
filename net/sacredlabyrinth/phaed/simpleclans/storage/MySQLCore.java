...
public class MySQLCore implements DBCore {
    ...
    public ResultSet select(String query) {
        try {
            return getConnection().createStatement().executeQuery(query.replaceAll("Ã", "").replaceAll("Â", ""));
    ...
    public void insert(String query) {
        if (SimpleClans.getInstance().getSettingsManager().getUseThreads()) {
            Thread th = new Thread(new ThreadUpdateSQL(getConnection(), query.replaceAll("Ã", "").replaceAll("Â", ""), "INSERT"));
            th.start();
        } else {
            try {
                getConnection().createStatement().executeUpdate(query.replaceAll("Ã", "").replaceAll("Â", ""));
            } catch (SQLException ex) {
    ...
    public void update(String query) {
        if (SimpleClans.getInstance().getSettingsManager().getUseThreads()) {
            Thread th = new Thread(new ThreadUpdateSQL(getConnection(), query.replaceAll("Ã", "").replaceAll("Â", ""), "UPDATE"));
            th.start();
        } else {
            try {
                getConnection().createStatement().executeUpdate(query.replaceAll("Ã", "").replaceAll("Â", ""));
    ...
    public void delete(String query) {
        if (SimpleClans.getInstance().getSettingsManager().getUseThreads()) {
            Thread th = new Thread(new ThreadUpdateSQL(getConnection(), query.replaceAll("Ã", "").replaceAll("Â", ""), "DELETE"));
            th.start();
        } else {
            try {
                getConnection().createStatement().executeUpdate(query.replaceAll("Ã", "").replaceAll("Â", ""));
    ...
    public Boolean execute(String query) {
        try {
            getConnection().createStatement().execute(query.replaceAll("Ã", "").replaceAll("Â", ""));
            return true;
        } catch (SQLException ex) {
